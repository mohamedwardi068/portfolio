...
const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    subtitle: 'Interactive Linux Desktop Simulator & Developer Workstation',
    description:
      'An immersive Ubuntu Linux workstation desktop environment simulator engineered entirely in the browser. Features a floating multi-window management engine with z-index stacking, Spotlight command launcher (Ctrl+K), interactive Bash terminal with command history, live system resource monitor, in-OS web browser, dynamic audio feedback, and tailored recruiter workflows.',
    problemSolved:
      'Transforms the standard static developer portfolio into an engaging, interactive operating system experience that demonstrates advanced frontend mastery, state management (Zustand), fluid animation choreography (Framer Motion), and responsive workstation ergonomics across desktop and mobile devices.',
    features: [
      'Multi-window manager with dynamic z-index stacking, dragging, minimizable/maximizable views, and focus delegation.',
      'Spotlight Command Launcher (Ctrl / Cmd + K) for instant keyboard-accessible app discovery.',
      'Interactive Bash terminal with command history, autocomplete, sound effects, and custom system tools.',
      'In-OS sandboxed web browser with multi-tab navigation, history stack, and bookmarks.',
      'Dynamic theme switcher (Ubuntu Yaru Orange, Dark Slate, Hacker Green) paired with procedural Web Audio API synthesizers.',
      'Responsive multi-device layout adapting from floating workstation windows to full-screen mobile app views with bottom dock.',
    ],
    tech: ['React 18', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Zustand', 'Web Audio API', 'Vite', 'Lucide React'],
    stars: 385,
    image: Laptop,
    githubUrl: 'https://github.com/mohamedwardi068/portfolio',
    demoUrl: 'https://grand-queijadas-012417.netlify.app/',
    linkedinUrl: 'https://www.linkedin.com/in/mohamed-wardi-69502b324/',
    videoUrl: 'https://res.cloudinary.com/dthb3ojqm/video/upload/v1787837353/demo_wprbnl.mp4',
    videoTitle: 'Portfolio OS — Workstation Experience • Live Demo & Walkthrough',
